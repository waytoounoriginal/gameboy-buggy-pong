...
void play_jumpy_sound() {
            ...
            // 0001 0 110 is 0x16, sweet time 1, sweep direction increase, shift ammount per step 110 (6 decimal)
            ...
            // 10 001000 is 0x40, duty cycle 1 (25%), wave length 0 (long)
            ...
            // 0111 0 011 is 0x73, volume 7, sweep down, step length 3
            ...
            // 6 Consecutive select/length counter enable (Read/Write). When "0", regardless of the length of data on the NR11 register, sound can be produ
            // 5-3 Unused
            // 2-0 3 Most Significant bits of frequency
            // 1 1 000 111 is 0xC3, initialize, no consecutive, frequency = MSB + LSB = 011 0000 0000 = 0x300
